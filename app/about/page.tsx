      ...
      <div className="flex justify-around items-center my-4 sm:my-8 lg:my-16">
        <div className="flex flex-col space-y-6">
          ...
          <div className="w-full xl:max-w-lg 2xl:max-w-xl">
            ...
            <span className="block text-base xl:text-lg text-neutral-600">
              🔥 It is entirely serverless! From the frontend hosted on Vercel,
              to the backend on AWS Lambda + Server Actions, and the database on
              AWS DynamoDB. No servers provisioned at all!
            </span>
          </div>
